    ...
    return `
      ...
      <div class="blog-entry product-item-box">
        ...
        <span class="product-item-brand">${
          data.kaImage
            ? `<img src="https://test.sourcedagile.com/api/get/files/${data.kaImage}" />`
            : '<img class="logo-example-dark" src="images/examle-logo-dark.jpg" /><img class="logo-example-light" src="images/examle-logo.jpg" />'
        }</span>
