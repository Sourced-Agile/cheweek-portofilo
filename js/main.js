...
(function($) {
   ...
   var burgerMenu = function() {
	...
	$('.product-single-carousel').on("initialized.owl.carousel changed.owl.carousel", function(e) {
		if (!e.namespace) {
		  return;
		}
	...
	$('#skin-link-id').remove()
     var a  =  $('#skin-theme');
		...
		if ($(this).hasClass('light-theme')){
			a.after('<link rel="stylesheet" id="skin-link-id" href="css/light-skin.css" />')
		}else{
			a.after('<link rel="stylesheet" id="skin-link-id" href="css/dark-skin.css" />')		
		}
